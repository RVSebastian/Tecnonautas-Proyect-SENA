    ...
    <div class="dash-content">
        <form action="save_task.php" method="POST" enctype="multipart/form-data">
            <div class="max-w-4xl mx-auto">
                ...
                <button type="submit" name="save_task" value="save"
                    class="text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Crear
                    Post</button>
            </div>
        </form>
    </div>
